...
class HexadecimalPageFragment : Fragment() {

    private val puzzledData = listOf(
        PuzzleModel(1),
        PuzzleModel(2),
        PuzzleModel(3),
        PuzzleModel(4),
    ...
    private val puzzleAdapter by lazy {
        HexadecimalPageAdapter { puzzleModel: PuzzleModel, emptyPuzzleModel: PuzzleModel ->
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_hexadecimal_page, container, false)
        playerButton=view.findViewById(R.id.hexadecimal_page_player_button)
        if (isPlay){
            mediaPlayer.start()
        ...
        cilcCounter=view.findViewById(R.id.hexadecimal_page_cilc_counter)
        timerTextView = view.findViewById(R.id.hexadecimal_page_tv_timer)
        val refreshButton = view.findViewById<ImageView>(R.id.refresh_button)
        refreshButton.setOnClickListener {
            puzzleAdapter.loadData(puzzledData.shuffled())
            startTime = SystemClock.uptimeMillis()
            customHandler.postDelayed(updateTimerThread, 0)
            counter = 0
            cilcCounter.text = counter.toString()
        ...
        timerPousButton=view.findViewById(R.id.hexadecimal_page_timet_pouse_button)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val backButton = view.findViewById<ImageView>(R.id.hexadecimal_page_bask_button)
