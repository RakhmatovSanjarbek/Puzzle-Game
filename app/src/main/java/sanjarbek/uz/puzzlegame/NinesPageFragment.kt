...
class NinesPageFragment : Fragment() {
    ...
    private val puzzleAdapter by lazy {
        NinesPageAdapter { puzzleModel: PuzzleModel, emptyPuzzleModel: PuzzleModel ->
            onIteamCilck(puzzleModel, emptyPuzzleModel)
        }
    }

    @OptIn(DelicateCoroutinesApi::class)
    private fun onIteamCilck(puzzleModel: PuzzleModel, emptyPuzzleModel: PuzzleModel) {
        puzzleAdapter.changeItem(puzzleModel, emptyPuzzleModel)
        if (puzzleAdapter.dataList.map { it.cardNumber } == listOf(1, 2, 3, 4, 5, 6, 7, 8, -1)) {
            showAlertDialog()
        }
        itemvoice.start()
        GlobalScope.launch {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_nines_page, container, false)
        playerButton = view.findViewById(R.id.nines_page_player_button)
        if (isPlay) {
            mediaPlayer.start()
        ...
        cilcCounter = view.findViewById(R.id.nines_page_cilc_counter)
        timerTextView = view.findViewById(R.id.nines_page_tv_timer)
        val refreshButton = view.findViewById<ImageView>(R.id.ninse_page_refresh_button)
        ...
        timerPousButton = view.findViewById(R.id.nines_page_timer_pous_button)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val rv = view.findViewById<RecyclerView>(R.id.nines_page_rv)
        ...
        val baskButton = view.findViewById<ImageView>(R.id.nines_page_bask_button)

        baskButton.setOnClickListener {
            showBackAlertDialog()
        }
    }
